...
const BadFeedbackPage: React.FC = () => {
  return (
    <PageTransition direction="left">
      ...
      >
        ...
        <h2 className="text-white text-xl text-center mb-10 font-normal z-10">What could we improve?</h2>
...
export default BadFeedbackPage; 